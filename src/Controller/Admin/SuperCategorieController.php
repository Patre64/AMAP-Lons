...
class SuperCategorieController extends AbstractController
{
    ...
    {
        return $this->render('admin/super_categorie/index.html.twig', ['super_categories' => $superCategorieRepository->findAll()]);
    }
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('admin/super_categorie/new.html.twig', [
    ...
    {
        return $this->render('admin/super_categorie/show.html.twig', ['super_categorie' => $superCategorie]);
    }
    ...
    public function edit(Request $request, SuperCategorie $superCategorie): Response
    {
        ...
        return $this->render('admin/super_categorie/edit.html.twig', [
            'super_categorie' => $superCategorie,
            'form' => $form->createView(),
        ]);
    }
