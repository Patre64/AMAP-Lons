...
class ProducteurController extends AbstractController
{
    ...
    {
        return $this->render('admin/producteur/index.html.twig', ['producteurs' => $producteurRepository->findAll()]);
    }
    ...
    {
        return $this->render('admin/producteur/show.html.twig', ['producteur' => $producteur]);
    }
    ...
    public function edit(Request $request, Producteur $producteur): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('producteur_edit', ['id' => $producteur->getId()]);
        }
